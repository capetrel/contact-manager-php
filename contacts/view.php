  ...
  <div class="container">
    <form class="form-horizontal" method="post" name=view-contact>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id="web" name="web" value="<?= Rec($contact['web']); ?>" pattern="^http:\/\/(.*)$" placeholder="http://" disabled>
        </div>
      </div>
      <a class="btn btn-info" href="update.php?id=<?= $contact['id']; ?>&p=<?= $_GET['p']; ?>">Modifier le contact</a>
</form>
